# +++ Made By Sanjiii [telegram username: @ryomen_0] +++
...
async def help(client: Client, message: Message):
    buttons = [
        [
            InlineKeyboardButton("🔥 ᴏᴡɴᴇʀ", url="https://t.me/ryomen_0"), 
            InlineKeyboardButton("👨‍💻 ᴅᴇᴠᴇʟᴏᴘᴇʀ", url="https://t.me/ryomen_0")
        ]
    ]
    if SUPPORT_GROUP:
        buttons.insert(0, [InlineKeyboardButton("•  sᴜᴘᴘᴏʀᴛ ᴄʜᴀᴛ ɢʀᴏᴜᴘ  •", url="https://t.me/+ue0ceedauFo1YmJl")])
    ...
    try:
        ...
        return await message.reply(f"<b><i>! ᴇʀʀᴏʀ, ᴄᴏɴᴛᴀᴄᴛ ᴅᴇᴠᴇʟᴏᴘᴇʀ ᴛᴏ sᴏʟᴠᴇ ᴛʜᴇ ɪssᴜᴇs @ryomen_0</i></b>\n<blockquote expandable><b>ʀᴇᴀsᴏɴ:</b> {e}</blockquote>")
